...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Erste",sLast:"Letzte",sNext:"Nächste",sPrevious:"Vorherige"},sEmptyTable:"Keine Daten in dieser Tabelle vorhanden",sInfo:"Zeige _START_ bis _END_ von _TOTAL_ Einträgen",sInfoEmpty:"Zeige 0 bis 0 von 0 Einträgen",sInfoFiltered:"(gefiltert von _MAX_ Gesamteinträgen)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Zeige _MENU_ Einträge",sLoadingRecords:"Laden...",sProcessing:"Verarbeiten...",sSearch:"Suche: ",sUrl:"",sZeroRecords:"Keine Übereinstimmungen gefunden"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
