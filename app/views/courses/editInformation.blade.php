			...
			<div class="panel panel-default">
		        <div class="panel-body">
					{{ Form::model($course, ['method' => 'PATCH', 'route' => ['updateCourse_path', $course->id], 'class' => 'form-horizontal']) }}
						...
						<div class="form-group">
							{{ Form::label('name_eng', 'engl. Name*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-10">
						...
						<div class="form-group">
							{{ Form::label('course_number', 'LV-Nr.*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-4">
							...
							{{ Form::label('coursetype_id', 'LV-Typ*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-4">
						...
						<div class="form-group">
							{{ Form::label('participants', 'Teilnehmer*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-4">
								{{ Form::input('number', 'participants', $course->participants, array('min' => 1, 'id' => "participants", 'class' => "form-control input-sm", 'required' => true)) }}
							</div>

							{{ Form::label('semester_periods_per_week', 'SWS*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-4">
						...
						<div class="form-group">
							{{ Form::label('language', 'Sprache*:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-4">
						...
						<div class="form-group">
							{{ Form::label('module_id', 'Modul:', ['class' => 'col-md-2 control-label']) }}
							<div class="col-md-10">
