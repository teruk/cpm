<div class="modal-dialog">
	<div class="modal-content">
  		<div class="modal-body">
    		{{ Form::model(new Planning, ['route' => ['savePlanningIndividual_path',$turnNav['displayTurn']->id], 'class' => "form-horizontal"])}}
    		...
    		<fieldset>
    			...
    			<div class="form-group">
    				...
    				<div class="col-lg-8">
    					{{ Form::textarea('comment', '', array('id' => "comment", 'class' => "form-control input-sm", 'placeholder' => 'Anmerkungen zu Lehraufträgen, Lehrenden, ...', 'rows'=>5, 'style' => 'resize:none;')) }}
    				</div>
    			</div>
                <div class="form-group">
    			...
    			<div class="form-group">
  					<div class="col-lg-8 col-lg-offset-3" style="text-align: right">
  					*erforderlich
