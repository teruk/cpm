...
@section('main')
	<div class="row">
		<div class="col-sm-12" style="margin-bottom: 5px;">
			<h4>Semesterplanung {{ $display_turn->name }} {{ $display_turn->year }}</h4>
		           		...
		           		<tbody>
							@foreach( $planned_courses as $planning )
								<tr>
		        					...
		        					<td><a href="{{ route('plannings.edit', array($display_turn->id,$planning->id)) }}">{{$planning->course_title }}</a></td>
		        					...
		        					<td>
		        						{{ Form::open(array('class' => 'inline', 'method' => 'DELETE', 'route' => array('plannings.destroy', $display_turn->id, $planning->id))) }}
		        						{{ HTML::decode(link_to_route('plannings.edit', '<i class="glyphicon glyphicon-edit"></i>', array($display_turn->id, $planning->id), array('class' => 'btn btn-xs btn-warning', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Planung bearbeiten'))) }}
