    ...
    <div class="modal-dialog">
	    <div class="modal-content">
	        <div class="modal-body">
		        {{ Form::model(new RoomType, ['route' => ['saveRoomtype_path'], 'class' => "form-horizontal"])}}
		        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		        <fieldset>
		        	<legend>Neuen Raumtyp anlegen</legend>
		        	...
		        	<div class="form-group">
	    				...
	    				<div class="col-lg-8">
	    					{{ Form::textarea('description', '', array('id' => "description", 'class' => "form-control input-sm", 'placeholder' => 'Anmerkungen zu Lehraufträgen, Verantwortlichen, ...', 'rows'=>5, 'style' => 'resize:none;')) }}
	    				</div>
	    			</div>
